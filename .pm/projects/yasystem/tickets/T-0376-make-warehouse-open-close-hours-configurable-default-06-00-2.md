...
assignee:
  ...
  name: claude-code
acceptance_criteria:
  - "[x] Warehouse open/close hours come from a single config value"
  - "[x] calculateWorkingMinutes() uses it"
  - "[x] Default 06:00-22:00 reproduces current behaviour"
  - "[x] Same value is available to the visualiser endpoint for shading"
out_of_scope: []
code_anchors:
