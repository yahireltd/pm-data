...
assignee:
  ...
  name: claude
acceptance_criteria:
  - "[x] Contextual help / tooltips on the main pages explaining what each surface + key control does (user-facing, not dev)"
  - "[x] A reusable tooltip/help-hint component used across pages"
  - "[x] AGENTS.md carries a rule that agents keep the user help/tooltips updated when a page or behaviour changes"
out_of_scope: []
code_anchors:
