...
updated: 2026-07-10T21:46:34Z
depends_on:
  - PH-005
goal: "Fix the known accounts-problem inflows that were deliberately scoped OUT of the 534/538 branches and have no code yet: test contracts leaking into Xero (T-0542), quote-builder pricing behaviour with Zsolt (T-0541), proforma generation (T-0539), sister-site generators (T-0540). Phase 2 releases the prevention already built; this phase builds the prevention still outstanding."
